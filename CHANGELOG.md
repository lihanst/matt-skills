...
- [`d4b95cf`](https://github.com/mattpocock/skills/commit/d4b95cf09348af5540b6d03a2a0e9e7d91f7b650) Thanks [@lihanst](https://github.com/lihanst)! - Add `testing` as the general testing reference for durable tests through public interfaces, without prescribing test-first ordering or a red-green-refactor loop. Keep the original `tdd` skill unchanged for users who explicitly want that workflow.
...
- [`c19635b`](https://github.com/mattpocock/skills/commit/c19635b0c42f9cc72be0f4751c8acfebedcb01e4) Thanks [@lihanst](https://github.com/lihanst)! - Expand `testing` to cover the shape of the suite, not only the quality of a single test.
