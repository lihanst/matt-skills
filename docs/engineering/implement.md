...
`implement` builds work that has already been decided. You point it at a [ticket](https://www.aihero.dev/ai-coding-dictionary/ticket), a [spec](https://www.aihero.dev/ai-coding-dictionary/spec), or the plan you just agreed in the conversation, and it writes the code, drives [testing](https://aihero.dev/skills-testing) at the seams, typechecks as it goes, runs [code-review](https://aihero.dev/skills-code-review) at the end, and commits to the current branch.
...
| One concrete behaviour you want tested with flexible timing, with no spec | [testing](https://aihero.dev/skills-testing) directly |
| One concrete behaviour you explicitly want test-first | [tdd](https://aihero.dev/skills-tdd) directly |
...
2. Drive [testing](https://aihero.dev/skills-testing) at the pre-agreed seams, one observable behaviour at a time.
...
- You can see an actual `/testing` invocation in the trace, not just tests appearing in the diff.
