...
- **[testing](./skills/engineering/testing/SKILL.md)**: General testing guidance for durable automated and integration tests through public interfaces, covering where tests live and how the suite is organised, without prescribing test-first ordering.
