...
- **[implement](./implement/SKILL.md)**: Build the work described by a spec or set of tickets, driving `/testing` at pre-agreed seams and closing out with `/code-review` before committing.
...
- **[testing](./testing/SKILL.md)**: General testing guidance for durable automated and integration tests through public interfaces, covering where tests live and how the suite is organised, without prescribing test-first ordering.
