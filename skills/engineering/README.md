...
- **[testing](./testing/SKILL.md)**: General testing guidance for durable automated and integration tests through public interfaces, without prescribing test-first ordering.
